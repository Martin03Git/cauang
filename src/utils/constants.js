...
const CATEGORIES = [
  { id: 'makanan', label: 'Makanan', icon: 'cake' },
  ...
  { id: 'jajan', label: 'Jajan', icon: 'gift' },
...
// ponytail: flat constant, move to config if localization needed
const MONTH_NAMES = [
